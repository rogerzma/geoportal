...
<div class="container">
    <ol class="breadcrumb top-buffer">
        ...
        <li><a href="{{ route('jefe-operativo-up') }}">Administrar unidades de producción</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                <a class="list-group-item" style="text-decoration:none;" href="{{ route('jefe_operativo') }}"><img src="/images/templatemo_list.png" style="margin-right:10px;" alt="">Inicio</a>
                <a class="list-group-item" style="text-decoration:none;" href="{{ route('jefe-operativo-up') }}"><img src="/images/templatemo_list.png" style="margin-right:10px;" alt="">Unidades de producción</a>
                <a class="list-group-item" style="text-decoration:none;" href="{{ route('usuarios-jefe_operativo') }}"><img src="/images/templatemo_list.png" style="margin-right:10px;" alt="">Usuarios</a>
            </div>
        </div>
...
<script src="{{ asset('js/jefe_operativo/poligonoJefeOperativo.js') }}?v={{ time() }}"></script>
