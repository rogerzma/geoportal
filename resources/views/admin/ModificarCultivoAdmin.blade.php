...
<div class="container">
    <ol class="breadcrumb top-buffer">
        ...
        <li>
            <a href="{{ route('administrar-cultivos-admin') }}">
                Cultivos
            </a>
        </li>
        ...
        <div class="col-md-3">
            ...
            <div class="list-group">
                ...
                <a
                    class="list-group-item"
                    style="text-decoration: none;"
                    href="{{ route('administrar-usuarios-admin') }}"
                >
                    <img
                        src="/images/templatemo_list.png"
                        style="margin-right: 10px;"
                ...
                <a
                    class="list-group-item"
                    style="text-decoration: none;"
                    href="{{ route('administrar-cultivos-admin') }}"
                >
                    <img
                        src="/images/templatemo_list.png"
                        style="margin-right: 10px;"
...
<script>
    const urlActualizarCultivo =
        "{{ route('actualizar.cultivo.admin', ['id' => $cultivo->id]) }}";

    const urlCultivosRedirect =
        "{{ route('administrar-cultivos-admin') }}";
</script>

<script src="{{ asset('js/admin/cultivos/modificarCultivosAdmin.js') }}?v={{ time() }}"></script>
