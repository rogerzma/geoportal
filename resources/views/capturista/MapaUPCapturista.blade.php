...
<body>
    ...
    <div class="container">
        <ol class="breadcrumb top-buffer">
            ...
            <li><a href="{{ route('capturista') }}">Jefe operativo</a></li>
            <li><a href="{{ route('capturista-up') }}">Administrar unidades de producción</a></li>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <a class="list-group-item" style="text-decoration: none;" href="{{ route('capturista-up') }}"><img src="/images/templatemo_list.png" style="margin-right:10px;">Unidades de producción</a>
    ...
    <script src="{{ asset('js/capturista/poligonoCapturista.js') }}"></script>
</body>
</html>