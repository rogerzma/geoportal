...
@section("title", "InicioCapturista")
...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-9">
            <div class="row">
                <h4><a href="{{ route('mapa-capturista') }}">Vista general del geoportal</a><br></h4>
                <h4><a href="{{ route('capturista-up') }}">Unidades de producción</a><br></h4>
        </div>
        </div>
    </div><br>
